...
def send_verification_email(receiver_email):
    ...
    msg = EmailMessage()
    msg["Subject"] = "Chintana AI - Email Verification Code"
    msg["From"] = "Chintana AI <nirvighnalnct@gmail.com>"
    ...
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
        <div style="max-width: 500px; margin: auto; background-color: #fff; padding: 30px; border-radius: 10px;">
          <h2 style="color: #2C5364; text-align: center;">Welcome to Chintana AI!</h2>
          <p>Thanks for signing up on <strong>Chintana AI</strong>.</p>
          ...
          <br>
          <p>Regards,<br><strong>Team Chintana AI</strong></p>
        </div>
      </body>
    </html>
    """, subtype='html')
...
def send_reset_otp(receiver_email):
    otp = str(random.randint(100000, 999999))
    msg = EmailMessage()
    msg["Subject"] = "Chintana AI - Password Reset Code"
    msg["From"] = "Chintana AI <nirvighnalnct@gmail.com>"
    msg["To"] = receiver_email
    ...
    <html>
      <body style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
        <div style="max-width: 500px; margin: auto; background-color: #fff; padding: 30px; border-radius: 10px;">
          <h2 style="color: #2C5364; text-align: center;">Chintana AI Password Reset</h2>
...
# ---- HEADER ----
st.markdown("<div class='title'>Welcome to Chintana</div>", unsafe_allow_html=True)
st.markdown("<div class='subtitle'>Login or Sign up to begin your AutoML journey</div>", unsafe_allow_html=True)
...
with tab1:
    ...
    if st.button("Login"):
        ...
        if result:
            ...
            st.switch_page("pages/automl_app.py")
        else:
